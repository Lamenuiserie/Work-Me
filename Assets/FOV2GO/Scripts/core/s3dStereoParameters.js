...
function toggleStereoParamGui(on : boolean) {
	if (on) {
		...
		#endif
		#if UNITY_4_0
			interaxialTouchpad.gameObject.SetActive(true);
			zeroPrlxTouchpad.gameObject.SetActive(true);
			hitTouchpad.gameObject.SetActive(true);
		#endif
		...
		#endif
		#if UNITY_4_0
			interaxialTouchpad.gameObject.SetActive(false);
			zeroPrlxTouchpad.gameObject.SetActive(false);
			hitTouchpad.gameObject.SetActive(false);
		#endif
